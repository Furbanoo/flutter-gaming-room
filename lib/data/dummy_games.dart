...
final dummyGames = [
  Games(
    ...
    description:
        'Uma reimaginação espetacular de um dos jogos mais visionários. FINAL FANTASY VII REMAKE reconstrói e expande o lendário RPG para hoje. A primeira entrada em uma saga multi-parte, entregando um nível de profundidade inconcebível para o original. História alucinante, personagens inesquecíveis, batalhas épicas e excelência técnica colidem. O mundo caiu o controle da Shinra Electric Power Company, uma corporação sombria que controla a força vital do planeta como energia mako. Na extensa cidade de Midgar, uma organização anti-Shinra que se autodenomina Avalanche intensificou sua resistência. Cloud Strife, um ex-membro da unidade de elite soldier de Shinra que agora se tornou mercenário, empresta sua ajuda ao grupo, sem saber das consequências épicas que o esperam. Funcionalidades do jogo: • Final Fantasy VII Remake reconta a história do jogo original. Ele segue Cloud Strife, um ex-soldado da megacorporação Shinra que se junta ao grupo ecoterrorista AVALANCHE • Tanto a exploração quanto as mecânicas de combate acontecem em tempo real similarmente à Final Fantasy XV. • Diferentemente do sistema "Active Time Battle" do original, Remake emprega um sistema de batalha em tempo real similar ao usado na série Kingdom Hearts, em que o jogadores podem controlar Cloud ou seus aliados livremente enquanto usam suas respectivas armas e habilidades para atacar inimigos. • Os jogadores também poderão utilizar magias e convocações, com a barra do Limit Break permitindo que os personagens realizem ataque poderosos uma vez totalmente carregada.',
  ...
  Games(
    ...
    description:
        'O LEGADO DOS CRISTAIS DEFINIU O DESTINO DA HUMANIDADE POR TEMPO DEMAIS Conheça Valisthea, um mundo sombrio de fantasia, neste tão aguardado RPG de ação para um jogador. O 16º jogo independente da lendária série Final Fantasy representa uma guinada mais sombria para a franquia de RPG, com uma trama complexa de vingança, disputas pelo poder e tragédia inevitável.',
  ...
  Games(
    cover:
        'https://cdn1.epicgames.com/offer/9533b9db84274b15886caa464445a975/EGST_StorePortrait_1200x1600_1200x1600-4e8995358cccb9b278b7556651242032',
    title: 'The Crew Motorfest',
    description:
        'BEM VINDO AO MOTORFEST: Adquira seu ingresso para um festival durante todo o ano projetado para todos os entusiastas de carros na bela ilha de O’Ahu',
    video: 'https://www.youtube.com/watch?v=YfbYkXH9jzY',
